...
public class TextSelectionCursorController implements CursorController {
    ...
    public void setActionModeCallBacks() {
        final ActionMode.Callback callback = new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                ...
                ClipboardManager clipboard = (ClipboardManager) terminalView.getContext()
        ...
        mActionMode = terminalView.startActionMode(new ActionMode.Callback2() {
            ...
            public void onGetContentRect(ActionMode mode, View view, Rect outRect) {
                ...
                int y1 = Math
                        .round((mSelY1 - 1 - terminalView.getTopRow()) * terminalView.mRenderer.getFontLineSpacing());
                int y2 = Math
                        .round((mSelY2 + 1 - terminalView.getTopRow()) * terminalView.mRenderer.getFontLineSpacing());
    ...
    @Nullable public String getStoredSelectedText() {
