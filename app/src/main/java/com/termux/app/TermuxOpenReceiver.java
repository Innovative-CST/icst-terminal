...
public class TermuxOpenReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Logger.logVerbose(LOG_TAG,
                "uri: \"" + data + "\", path: \"" + data.getPath() + "\", fragment: \"" + data.getFragment() + "\"");
        ...
        Uri uriToShare = UriUtils.getContentUri(TermuxConstants.TERMUX_FILE_SHARE_URI_AUTHORITY,
    ...
    public static class ContentProvider extends android.content.ContentProvider {
        ...
        public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String mode) throws FileNotFoundException {
            ...
            try {
                ...
                Logger.logDebug(LOG_TAG, "Open file request received from " + callingPackageName + " for \"" + path
                        + "\" with mode \"" + mode + "\"");
