    ...
    public static class RootPreferencesFragment extends PreferenceFragmentCompat {
                ...
                aboutPreference.setOnPreferenceClickListener(preference -> {
                    new Thread() {
                        ...
                        public void run() {
                            ...
                            aboutString.append(TermuxUtils.getAppInfoMarkdownString(context,
        ...
        private void configureDonatePreference(@NonNull Context context) {
            ...
            if (donatePreference != null) {
                String signingCertificateSHA256Digest = PackageUtils
                        .getSigningCertificateSHA256DigestForPackage(context);
                if (signingCertificateSHA256Digest != null) {
                    ...
                    if (apkRelease == null || apkRelease
                            .equals(TermuxConstants.APK_RELEASE_GOOGLE_PLAYSTORE_SIGNING_CERTIFICATE_SHA256_DIGEST)) {
