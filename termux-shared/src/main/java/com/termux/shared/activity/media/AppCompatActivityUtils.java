        ...
        if (toolbar != null) {
            ...
            try {
                ...
                Logger.logStackTraceWithMessage(LOG_TAG,
                        "Failed to set toolbar title appearance to style resource id " + titleAppearance, e);
            }
    ...
    public static void setToolbarSubtitle(@NonNull AppCompatActivity activity, @IdRes int id,
        ...
        if (toolbar != null) {
            ...
            try {
                ...
                Logger.logStackTraceWithMessage(LOG_TAG,
                        "Failed to set toolbar subtitle appearance to style resource id " + subtitleAppearance, e);
            }
        }
    }
