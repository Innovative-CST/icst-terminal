...
public class ResultData implements Serializable {
    ...
    public String getStdoutLogString() {
        if (stdout.toString().isEmpty())
            ...
            return Logger.getMultiLineLogStringEntry("Stdout", DataUtils.getTruncatedCommandOutput(stdout.toString(),
                    Logger.LOGGER_ENTRY_MAX_SAFE_PAYLOAD / 5, false, false, true), "-");
    }
    ...
    public String getStderrLogString() {
        if (stderr.toString().isEmpty())
            ...
            return Logger.getMultiLineLogStringEntry("Stderr", DataUtils.getTruncatedCommandOutput(stderr.toString(),
                    Logger.LOGGER_ENTRY_MAX_SAFE_PAYLOAD / 5, false, false, true), "-");
    }
    ...
    public static String getResultDataMarkdownString(final ResultData resultData) {
        ...
        if (resultData.stdout.toString().isEmpty())
            ...
            markdownString
                    .append(MarkdownUtils.getMultiLineMarkdownStringEntry("Stdout", resultData.stdout.toString(), "-"));
