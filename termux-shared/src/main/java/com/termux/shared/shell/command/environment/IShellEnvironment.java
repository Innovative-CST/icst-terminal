...
public interface IShellEnvironment {
     ...
     */
    @NonNull String getDefaultWorkingDirectoryPath();
     ...
     */
    @NonNull String getDefaultBinPath();
     ...
     */
    @NonNull String[] setupShellCommandArguments(@NonNull String fileToExecute, @Nullable String[] arguments);
     ...
     */
    @NonNull HashMap<String, String> setupShellCommandEnvironment(@NonNull Context currentPackageContext,
