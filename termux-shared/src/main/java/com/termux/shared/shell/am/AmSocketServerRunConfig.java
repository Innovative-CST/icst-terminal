...
public class AmSocketServerRunConfig extends LocalSocketRunConfig implements Serializable {
     ...
     */
    public AmSocketServerRunConfig(@NonNull String title, @NonNull String path,
    ...
    public boolean shouldCheckDisplayOverAppsPermission() {
        return mCheckDisplayOverAppsPermission != null ? mCheckDisplayOverAppsPermission
     ...
     */
    @NonNull public static String getRunConfigLogString(final AmSocketServerRunConfig config) {
        if (config == null)
            return "null";
    ...
    @NonNull public String getLogString() {
        ...
        logString.append("\n").append(Logger.getSingleLineLogStringEntry("CheckDisplayOverAppsPermission",
                shouldCheckDisplayOverAppsPermission(), "-"));
