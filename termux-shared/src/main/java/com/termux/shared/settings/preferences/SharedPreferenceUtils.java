...
public class SharedPreferenceUtils {
    ...
    public static boolean getBoolean(SharedPreferences sharedPreferences, String key, boolean def) {
        if (sharedPreferences == null) {
            Logger.logError(LOG_TAG, "Error getting boolean value for the \"" + key
                    + "\" key from null shared preferences. Returning default value \"" + def + "\".");
            return def;
        }
        ...
        try {
            ...
            Logger.logStackTraceWithMessage(LOG_TAG, "Error getting boolean value for the \"" + key
                    + "\" key from shared preferences. Returning default value \"" + def + "\".", e);
            return def;
        }
    }
    ...
    public static void setBoolean(SharedPreferences sharedPreferences, String key, boolean value,
        ...
        if (sharedPreferences == null) {
            Logger.logError(LOG_TAG, "Ignoring setting boolean value \"" + value + "\" for the \"" + key
    ...
    public static float getFloat(SharedPreferences sharedPreferences, String key, float def) {
        if (sharedPreferences == null) {
            Logger.logError(LOG_TAG, "Error getting float value for the \"" + key
                    + "\" key from null shared preferences. Returning default value \"" + def + "\".");
            return def;
        }
        ...
        try {
            ...
            Logger.logStackTraceWithMessage(LOG_TAG, "Error getting float value for the \"" + key
                    + "\" key from shared preferences. Returning default value \"" + def + "\".", e);
            return def;
        }
    }
    ...
    public static void setFloat(SharedPreferences sharedPreferences, String key, float value, boolean commitToFile) {
        if (sharedPreferences == null) {
            Logger.logError(LOG_TAG, "Ignoring setting float value \"" + value + "\" for the \"" + key
                    + "\" key into null shared preferences.");
            return;
        }
    ...
    public static int getInt(SharedPreferences sharedPreferences, String key, int def) {
        if (sharedPreferences == null) {
            Logger.logError(LOG_TAG, "Error getting int value for the \"" + key
                    + "\" key from null shared preferences. Returning default value \"" + def + "\".");
            return def;
        }
        ...
        try {
            ...
            Logger.logStackTraceWithMessage(LOG_TAG, "Error getting int value for the \"" + key
                    + "\" key from shared preferences. Returning default value \"" + def + "\".", e);
            return def;
        }
    }
    ...
    public static void setInt(SharedPreferences sharedPreferences, String key, int value, boolean commitToFile) {
        if (sharedPreferences == null) {
            Logger.logError(LOG_TAG, "Ignoring setting int value \"" + value + "\" for the \"" + key
                    + "\" key into null shared preferences.");
            return;
        }
    ...
    public static long getLong(SharedPreferences sharedPreferences, String key, long def) {
        if (sharedPreferences == null) {
            Logger.logError(LOG_TAG, "Error getting long value for the \"" + key
                    + "\" key from null shared preferences. Returning default value \"" + def + "\".");
            return def;
        }
        ...
        try {
            ...
            Logger.logStackTraceWithMessage(LOG_TAG, "Error getting long value for the \"" + key
                    + "\" key from shared preferences. Returning default value \"" + def + "\".", e);
            return def;
        }
    }
    ...
    public static void setLong(SharedPreferences sharedPreferences, String key, long value, boolean commitToFile) {
        if (sharedPreferences == null) {
            Logger.logError(LOG_TAG, "Ignoring setting long value \"" + value + "\" for the \"" + key
                    + "\" key into null shared preferences.");
            return;
        }
    ...
    public static String getString(SharedPreferences sharedPreferences, String key, String def, boolean defIfEmpty) {
        if (sharedPreferences == null) {
            Logger.logError(LOG_TAG, "Error getting String value for the \"" + key
                    + "\" key from null shared preferences. Returning default value \"" + def + "\".");
            return def;
        }
        ...
        try {
            ...
            Logger.logStackTraceWithMessage(LOG_TAG, "Error getting String value for the \"" + key
                    + "\" key from shared preferences. Returning default value \"" + def + "\".", e);
            return def;
        }
    }
    ...
    public static void setString(SharedPreferences sharedPreferences, String key, String value, boolean commitToFile) {
        if (sharedPreferences == null) {
            Logger.logError(LOG_TAG, "Ignoring setting String value \"" + value + "\" for the \"" + key
                    + "\" key into null shared preferences.");
            return;
        }
    ...
    public static Set<String> getStringSet(SharedPreferences sharedPreferences, String key, Set<String> def) {
        if (sharedPreferences == null) {
            Logger.logError(LOG_TAG, "Error getting Set<String> value for the \"" + key
                    + "\" key from null shared preferences. Returning default value \"" + def + "\".");
            return def;
        }
        ...
        try {
            ...
            Logger.logStackTraceWithMessage(LOG_TAG, "Error getting Set<String> value for the \"" + key
                    + "\" key from shared preferences. Returning default value \"" + def + "\".", e);
            return def;
        }
    }
     ...
     */
    @SuppressLint("ApplySharedPref")
    public static void setStringSet(SharedPreferences sharedPreferences, String key, Set<String> value,
            boolean commitToFile) {
        if (sharedPreferences == null) {
            Logger.logError(LOG_TAG, "Ignoring setting Set<String> value \"" + value + "\" for the \"" + key
                    + "\" key into null shared preferences.");
            return;
        }
