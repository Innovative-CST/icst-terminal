...
public class Logger {
    ...
    @NonNull public static String getDefaultLogTag() {
    ...
    public static int setLogLevel(Context context, int logLevel) {
        ...
        if (context != null)
            showToast(context,
                    context.getString(R.string.log_level_value, getLogLevelLabel(context, CURRENT_LOG_LEVEL, false)),
                    true);
    ...
    public static boolean shouldEnableLoggingForCustomLogLevel(Integer customLogLevel) {
        ...
        if (customLogLevel <= LOG_LEVEL_OFF)
            return false;
