...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    public static void setDefaultCrashHandler(@NonNull final Context context,
            @NonNull final CrashHandlerClient crashHandlerClient) {
    ...
    public void logCrashToFile(@NonNull Context context,
        ...
        reportString.append("\n").append(MarkdownUtils.getSingleLineMarkdownStringEntry("Crash Timestamp",
    ...
    public interface CrashHandlerClient {
         ...
         */
        @NonNull String getCrashLogFilePath(Context context);
