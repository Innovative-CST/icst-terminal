...
public class TermuxNotificationUtils {
     ...
     */
    public static synchronized int getNextNotificationId(final Context context) {
        if (context == null)
     ...
     */
    @Nullable public static Notification.Builder getTermuxOrPluginAppNotificationBuilder(final Context currentPackageContext,
