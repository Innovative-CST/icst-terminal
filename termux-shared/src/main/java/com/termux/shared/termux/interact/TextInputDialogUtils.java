    ...
    public static void textInput(Activity activity, int titleText, String initialText,
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(activity)
                ...
                .setPositiveButton(positiveButtonText,
                        (d, whichButton) -> onPositive.onTextSet(input.getText().toString()));

        if (onNeutral != null) {
            builder.setNeutralButton(neutralButtonText,
                    (dialog, which) -> onNeutral.onTextSet(input.getText().toString()));
        }
        ...
        if (onNegative == null) {
            ...
            builder.setNegativeButton(negativeButtonText,
                    (dialog, which) -> onNegative.onTextSet(input.getText().toString()));
        }
