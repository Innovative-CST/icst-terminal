...
public class ExtraKeyButton {
     ...
     */
    @Nullable private final ExtraKeyButton popup;
    ...
    public ExtraKeyButton(@NonNull JSONObject config, @Nullable ExtraKeyButton popup,
        ...
        if (keyFromConfig != null && macroFromConfig != null) {
            throw new JSONException("Both key and macro can't be set for the same key. key: \"" + keyFromConfig
                    + "\", macro: \"" + macroFromConfig + "\"");
    ...
    /** Get {@link #popup}. */
    @Nullable public ExtraKeyButton getPopup() {
        return popup;
    }
