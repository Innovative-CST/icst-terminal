...
public class NotificationUtils {
     ...
     */
    @Nullable public static NotificationManager getNotificationManager(final Context context) {
        if (context == null)
            return null;
     ...
     */
    @Nullable public static Notification.Builder geNotificationBuilder(
     ...
     */
    public static void setupNotificationChannel(final Context context, final String channelId,
            final CharSequence channelName, final int importance) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O)
            return;
    ...
    public static Notification.Builder setNotificationDefaults(Notification.Builder builder,
