...
public enum NightMode {
    ...
    @Nullable public static NightMode modeOf(String name) {
    ...
    @NonNull public static NightMode modeOf(@Nullable String name, @NonNull NightMode def) {
    ...
    @NonNull public static NightMode getAppNightMode() {
