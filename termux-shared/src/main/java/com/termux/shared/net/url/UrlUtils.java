...
public class UrlUtils {
    ...
    public enum UrlPart {
        AUTHORITY, FILE, HOST, REF, FRAGMENT, PATH, PORT, PROTOCOL, QUERY, USER_INFO
    }
     ...
     */
    @Nullable public static String joinUrl(final String base, String destination, boolean logError) {
        ...
        try {
            ...
            if (logError)
                Logger.logError(LOG_TAG, "Failed to join url base \"" + base + "\" and destination \"" + destination
                        + "\": " + e.getMessage());
            return null;
        }
    }
     ...
     */
    @Nullable public static URL getUrl(String urlString) {
     ...
     */
    @Nullable public static String getUrlPart(String urlString, UrlPart urlPart) {
    ...
    public static boolean areUrlsEqual(String url1, String url2) {
        ...
        if (url1 == null || url2 == null)
            return false;
        return UrlUtils.removeProtocol(url1).replaceAll("/+$", "")
