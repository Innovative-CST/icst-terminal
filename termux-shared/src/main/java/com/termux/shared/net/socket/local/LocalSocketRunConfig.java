...
public class LocalSocketRunConfig implements Serializable {
     ...
     */
    public LocalSocketRunConfig(@NonNull String title, @NonNull String path,
            @NonNull ILocalSocketManager localSocketManagerClient) {
        mTitle = title;
     ...
     */
    @NonNull public static String getRunConfigLogString(final LocalSocketRunConfig config) {
        if (config == null)
            return "null";
    ...
    @NonNull public String getLogString() {
        ...
        logString.append("\n").append(Logger.getSingleLineLogStringEntry("LocalSocketManagerClient",
                mLocalSocketManagerClient.getClass().getName(), "-"));
    ...
    @NonNull public String getMarkdownString() {
        ...
        markdownString.append("\n").append(MarkdownUtils.getSingleLineMarkdownStringEntry("AbstractNamespaceSocket",
                mAbstractNamespaceSocket, "-"));
        markdownString.append("\n").append(MarkdownUtils.getSingleLineMarkdownStringEntry("LocalSocketManagerClient",
                mLocalSocketManagerClient.getClass().getName(), "-"));
